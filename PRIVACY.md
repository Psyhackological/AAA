...
# As you can see, it has been overwhelmed because there are lots of apps to examine. It can easily get out of date, and I cannot guarantee that an app is 100% privacy-aware while having little to no help. Instead, I have created a [Privacy Examination Manual](PRIVACY_MANUAL.md) to help you determine if the app is fully privacy friendly. This way I can add more apps without extra work.
...
<img alt="Flashy" height="64" src="https://github.com/Crazy-Marvin/Flashy/blob/development/app/src/main/ic_launcher-web.png?raw=true">

- [x] [εxodus report](https://reports.exodus-privacy.eu.org/en/reports/rocks.poopjournal.flashy/latest/): 0 trackers, 2 permissions
- [x] [F-Droid Anti-Features](https://f-droid.org/en/packages/rocks.poopjournal.flashy/): 0
- [x] [Privacy Policy](https://crazymarvin.com/flashy/): no bits collection.

> This mobile flashlight is very privacy-friendly, your safety is guaranteed and most importantly it is an ad-free flashlight so you won’t be interrupted using it.
